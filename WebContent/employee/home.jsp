...
<body style="background-color: #f8f9fa !important;">
	...
	PreparedStatement ps = con.prepareStatement("select count(*) from complaints where status=0 and user_id=?");
    ...
    ps = con.prepareStatement("select count(*) from complaints where status=1 and user_id=?");
    ps.setInt(1, (int) session.getAttribute("id"));
    rs = ps.executeQuery();
    if(rs.next()) {
     close = rs.getInt(1);   
