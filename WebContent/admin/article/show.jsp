                ...
                <tbody>
                    <%
                        ...
                        <tr>
                            ...
                            <td>
                            <a class="btn btn-success" href="edit.jsp?id=<%=rs.getInt(1)%>" role="button">Edit</a>
                            <a onclick="return confirm('Are you sure you want to delete it?');" class="btn btn-danger" href="ArticleDelete?id=<%= rs.getInt(1) %>" role="button">Delete</a>
                            </td>
                        </tr>
                        <%   
                        }
