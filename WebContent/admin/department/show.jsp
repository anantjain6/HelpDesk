...
<body style="background-color: #f8f9fa !important;">
    ...
    <div class="card">
        <div class="card-header text-white shadow bg-dark">
            <h2 class="float-left">Departments</h2>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <%
                    	...
                    	PreparedStatement ps = con.prepareStatement("select id,name from departments order by id desc");
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-success" href="edit.jsp?id=<%=rs.getInt(1)%>" role="button">Edit</a> <a
                                 onclick="return confirm('Are you sure you want to delete it?');" class="btn btn-danger" href="DepartmentDelete?id=<%= rs.getInt(1) %>" role="button">Delete</a></td>
                        </tr>
                        <%   
                        }
                    %>
