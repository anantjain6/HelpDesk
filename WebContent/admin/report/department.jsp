            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <%
                    	...
                    	PreparedStatement ps = con.prepareStatement("select id,title,description,open,technician_id,category_id,user_id,close,nvl(trunc(close-open), -1) from complaints where dept_id=? order by id desc");
